...
file_path = os.path.join(script_dir, 'AE_distance_w_table.xlsx')
...
try:
    ...
    plt.xlabel('Distance Loss Weight / Total Loss')
    plt.ylabel('Recall')
    plt.legend()
    plt.grid(True, linestyle='--', alpha=0.7)
    
    output_path = os.path.join(script_dir, 'ae_distance_weight_comparison.png')
